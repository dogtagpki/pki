...
BuildRequires:    mvn(org.apache.tomcat:tomcat-servlet-api) >= 10.1.24
BuildRequires:    mvn(org.apache.tomcat:tomcat-jaspic-api) >= 10.1.22
BuildRequires:    mvn(org.apache.tomcat:tomcat-util-scan) >= 10.0.62

BuildRequires:    mvn(org.dogtagpki.jss:jss-base) >= 5.7.0
BuildRequires:    mvn(org.dogtagpki.jss:jss-tomcat) >= 5.7.0
...
Requires:         mvn(org.dogtagpki.jss:jss-base) >= 5.7.0
...
Requires:         tomcat >= 1:10.1.24
Requires:         mvn(org.dogtagpki.jss:jss-tomcat) >= 5.7.0
...
#xmvn --batch-mode  --debug verify org.fedoraproject.xmvn:xmvn-mojo:install org.fedoraproject.xmvn:xmvn-mojo:builddep
