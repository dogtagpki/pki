...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   Description: ca-authority tests for Delete
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   Author: Deepak Punia
#
...
def test_pki_ca_authority_delete_help(ansible_module, args):
    """
    ...
    :Steps:
        1. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                -n "PKI CA Administrator for Example.Org" ca-authority-del --help
        2. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                -n "PKI CA Administrator for Example.Org" ca-authority-del asdf
    :Expected results:
    ...
    cmd_out = ansible_module.pki(cli="ca-authority-del",
                                 ...
                                 extra_args='{} --force'.format(args))
    for result in cmd_out.values():
        if args == '--help':
            assert result['rc'] == 0
            assert "--force     Force delete" in result['stdout']
...
def test_pki_ca_authority_delete_authority(ansible_module):
    """
    ...
    :Steps:
        ...
        3. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                -n "PKI CA Administrator for Example.Org" ca-authority-del "authority ID"
    :Expected results:
...
def test_pki_ca_authority_delete_as_anonymous_user(ansible_module):
    """
    :Title: pki ca-authority-del as anonymous user
    :Description: Execute pki ca-authority-del as anonymous user should fail
    :Requirement:
    :Setup: Use the subsystems setup in ansible to run subsystem commands
    :Steps:
        1. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com
                -c SECret.123 ca-authority-del caAgentFoobar
    :Expected results:
...
def test_pki_ca_authority_delete_as_non_existing_authority(ansible_module):
    """
    ...
    :Steps:
        1. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
           -n "PKI CA Administrator for Example.Org" ca-authority-del NonExistingauthority
    :Expected results:
    ...
    cmd_out = ansible_module.pki(cli="ca-authority-del",
                                 ...
                                 hostname=constants.MASTER_HOSTNAME,
                                 certnick='"{}"'.format(constants.CA_ADMIN_NICK),
                                 extra_args='{} --force'.format('NonExistingAuthority'))
    for result in cmd_out.values():
        if result['rc'] >= 1:
            assert 'NonExistingAuthority' in result['stderr']
            log.info("Successfully ran : {}".format(result['cmd']))
        else:
...
def test_pki_ca_authority_delete_with_valid_user_cert(valid_user_cert, ansible_module):
    """
    ...
    Create the authority with different valid user's certs
        1. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                    ...
                    CN="Authority Name" --parent "Authority ID"
        2. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                    -n "CA_AdminV" ca-authority-del "authority ID"
    :Expected results:
...
def test_pki_ca_authority_delete_with_revoked_user_cert(revoked_user_cert, ansible_module):
    """
    ...
    Create the authority with different revoked user's certs
        1. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                    ...
                    CN="Authority Name" --parent "Authority ID"
        2. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                    -n "CA_AdminR" ca-authority-del "authority ID"
    :Expected results:
        1. It should create the authority
...
def test_pki_ca_authority_delete_with_expired_user_cert(expired_user_cert, ansible_module):
    """
    ...
    Create the authority with different Expired user's certs
        ...
        2. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                -n "CA_AdminE" ca-authority-del "authority ID"
        3. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                -n "CA_AdminE" ca-authority-del "authority ID"
        4. pki -d /opt/pki/certdb -P http -p 20080 -h pki1.example.com -c SECret.123
                -n "CA_AgentE" ca-authority-del "authority ID"
    :Expected results:
        1. It should create the authority
...
def test_pki_ca_authority_delete_with_normal_user_cert(ansible_module):
    """
