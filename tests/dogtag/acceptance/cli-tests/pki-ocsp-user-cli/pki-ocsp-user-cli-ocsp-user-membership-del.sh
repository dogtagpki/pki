...
run_pki-ocsp-user-cli-ocsp-user-membership-del_tests(){
  ...
  if [ "$ocsp_instance_created" = "TRUE" ] ;  then
	...
	rlPhaseStartTest "pki_ocsp-user_cli_ocsp_user_membership-del-016: Delete ocsp-user-membership for user fullname with i18n characters"
 			   ...
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-group-add 'dadministʁasjɔ̃' --description \"Admininstartors in French\" 2>&1 > $TmpDir/pki-ocsp-user-membership-add-groupadd-ocsp-017_1.out" \
                            0 \
                            "Adding group dadministʁasjɔ̃ with i18n characters"
                rlAssertGrep "Added group \"dadministʁasjɔ̃\"" "$TmpDir/pki-ocsp-user-membership-add-groupadd-ocsp-017_1.out"
                rlAssertGrep "Group ID: dadministʁasjɔ̃" "$TmpDir/pki-ocsp-user-membership-add-groupadd-ocsp-017_1.out"
 			   ...
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-user-membership-add u10 \"dadministʁasjɔ̃\""
                rlRun "pki -d $CERTDB_DIR \
                           -n ${prefix}_adminV \
                           -c $CERTDB_DIR_PASSWORD \
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-user-membership-add u10 \"dadministʁasjɔ̃\" > $TmpDir/pki-ocsp-user-membership-del-groupadd-ocsp-017_2.out" \
                            0 \
                            "Adding user ÉricTêko to group \"dadministʁasjɔ̃\""
                rlAssertGrep "Added membership in \"dadministʁasjɔ̃\"" "$TmpDir/pki-ocsp-user-membership-del-groupadd-ocsp-017_2.out"
                rlAssertGrep "Group: dadministʁasjɔ̃" "$TmpDir/pki-ocsp-user-membership-del-groupadd-ocsp-017_2.out"
		rlLog "Delete ocsp-user-membership from the group"
 			   ...
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-user-membership-del u10  'dadministʁasjɔ̃' > $TmpDir/pki-ocsp-user-membership-del-017_3.out" \
                            0 \
                            "Delete ocsp-user-membership from group \"dadministʁasjɔ̃\""
		rlAssertGrep "Deleted membership in group \"dadministʁasjɔ̃\"" "$TmpDir/pki-ocsp-user-membership-del-017_3.out"
		rlLog "Check if the user is removed from the group"
 			   ...
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ...
                            0 \
                            "Find ocsp-user-membership with group \"dadministʁasjɔ̃\""
	...
	rlPhaseStartTest "pki_ocsp-user_cli_ocsp_user_membership-del-017: Delete ocsp-user-membership for user fullname with i18n characters"
 			   ...
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-user-add --fullName='ÖrjanÄke' u11 > $TmpDir/pki-ocsp-user-add-ocsp-018.out 2>&1" \
                            0 \
 			   ...
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-user-membership-add u11 \"dadministʁasjɔ̃\""
                rlRun "pki -d $CERTDB_DIR \
                           -n ${prefix}_adminV \
                           -c $CERTDB_DIR_PASSWORD \
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-user-membership-add u11 \"dadministʁasjɔ̃\" > $TmpDir/pki-ocsp-user-membership-del-groupadd-ocsp-018_2.out" \
                            0 \
                            "Adding user with full name ÖrjanÄke to group \"dadministʁasjɔ̃\""
                rlAssertGrep "Added membership in \"dadministʁasjɔ̃\"" "$TmpDir/pki-ocsp-user-membership-del-groupadd-ocsp-018_2.out"
                rlAssertGrep "Group: dadministʁasjɔ̃" "$TmpDir/pki-ocsp-user-membership-del-groupadd-ocsp-018_2.out"
		rlLog "Delete user from the group"
 			   ...
 			   -h $SUBSYSTEM_HOST \
 			   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                            ocsp-user-membership-del u11 \"dadministʁasjɔ̃\" > $TmpDir/pki-ocsp-user-membership-del-groupadd-del-018_3.out" \
                            0 \
                            "Delete ocsp-user-membership from the group \"dadministʁasjɔ̃\""
		rlAssertGrep "Deleted membership in group \"dadministʁasjɔ̃\"" "$TmpDir/pki-ocsp-user-membership-del-groupadd-del-018_3.out"
                rlLog "Check if the user is removed from the group"
                rlRun "pki -d $CERTDB_DIR \
                           -n ${prefix}_adminV \
                           -c $CERTDB_DIR_PASSWORD \
...
Import CA certificate (Y/n)? \"" >> $expfile
	...
	rlPhaseEnd
		...
		rlRun "pki -d $CERTDB_DIR \
 			...
 			-h $SUBSYSTEM_HOST \
 			-p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                        ocsp-group-del 'dadministʁasjɔ̃' > $TmpDir/pki-ocsp-user-del-group-i18n_1.out" \
                        0 \
                        "Deleting group dadministʁasjɔ̃"
                rlAssertGrep "Deleted group \"dadministʁasjɔ̃\"" "$TmpDir/pki-ocsp-user-del-group-i18n_1.out"
