...
run_pki-cert-request-submit_tests()
{
	...
	rlPhaseStartTest "pki_cert_request_submit-001: Submit anonymous pkcs10 request and verify by approving the request"
	...
	rlPhaseEnd
        ...
        rlPhaseStartTest "pki_cert_request_submit-002: Submit anonymous crmf request and verify by approving the request"
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_cert_request_submit-003: Test-1 Submit i18n characters request and verify by approving the request"
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        rlPhaseStartTest "pki_cert_request_submit-004: Test-2 Submit i18n characters request with Key Archival and verify by approving the request"
	...
	rlPhaseStartTest "pki_cert_request_submit-005: Test-3 Submit i18n characters request and verify by approving the request"
        ...
        rlPhaseStartTest "pki_cert_request_submit-006: Test-4 Submit i18n characters request and verify by approving the request"
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        rlPhaseStartTest "pki_cert_request_submit-007: Test-5 Submit i18n characters request and verify by approving the request"
	...
	rlPhaseEnd
        ...
        rlPhaseStartTest "pki_cert_request_submit-0010: Submit request which doesn't satisfy constraints of profile"
        local profile=caUserCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        local REQUEST_SUBMIT_STATUS=$(cat $TEMP_NSS_DB/pki-cert-request-submit.out | grep "Operation Result" | awk -F ": " '{print $2}')
        rlAssertGrep "Type: enrollment"  "$TEMP_NSS_DB/pki-cert-request-submit.out"
        rlAssertGrep "Request Status: rejected" "$TEMP_NSS_DB/pki-cert-request-submit.out"
        rlAssertGrep "Operation Result: success" "$TEMP_NSS_DB/pki-cert-request-submit.out"
        rlPhaseEnd

	rlPhaseStartTest "pki_cert_request_submit-0011: Submit pkcs10 request using valid agent cert and verify by approving the request"
        local profile=caUserCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
	...
	rlPhaseStartTest "pki_cert_request_submit-0012: Submit crmf request using Revoked agent cert"
	local profile=caDualCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:crmf algo:rsa \
	...
	rlPhaseStartTest "pki_cert_request_submit-0013: Submit pkcs10 request using valid admin cert and verify by approving the request"
	local profile=caServerCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        rlPhaseStartTest "pki_cert_request_submit-0014: Submit pkcs10 request using Revoked admin cert"
        local profile=caSignedLogCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        rlPhaseStartTest "pki_cert_request_submit-0015: Submit pkcs10 request using valid audit cert and verify by approving the request"
        local profile=caTPSCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        rlPhaseStartTest "pki_cert_request_submit-0016: Submit pkcs10 request using valid operator cert and verify by approving the request"
        local profile=caServerCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        rlPhaseStartTest "pki_cert_request_submit-0017: Submit pkcs10 request using normal user without any privileges and verify by approving the request"
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_cert_request_submit-0018: Submit cert request using host URI parameter(http)"
        local profile=caUserCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
	...
	rlPhaseStartTest "pki_cert_request_submit-0020: submit cert request using valid user"
	local profile=caUserCert
	...
	rlRun "pki -d $CERTDB_DIR -n \"$CA_adminV_user\" \
        ...
        rlPhaseStartTest "pki_cert_request_submit-0021: submit cert request using in-valid user"
        local profile=caUserCert
	...
	rlLog "Update $profile xml with certificate request details"
        ...
        rlPhaseStartTest "pki_cert_request_submit-0022: Submit pkcs10 request using Expired admin cert"
        local profile=caUserCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
        ...
        rlPhaseStartTest "pki_cert_request_submit-0023: Submit pkcs10 request using Expired agent cert"
        local profile=caUserCert
        rlRun "create_new_cert_request nss_db:$TEMP_NSS_DB nss_db_pwd:$TEMP_NSS_DB_PWD req_type:pkcs10 algo:rsa \
