...
run_pki-tps-user-cli-tps-user-add_tests(){
   ...
   rlPhaseEnd
	...
	rlLog "tps-user-add fullname Örjan Äke with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName='Örjan Äke' u26 > $TmpDir/pki-tps-user-add-001_51.out 2>&1" \
                    0 \
	...
	rlAssertGrep "Added user \"u26\"" "$TmpDir/pki-tps-user-add-001_51.out"
        ...
        rlAssertGrep "Full name: Örjan Äke" "$TmpDir/pki-tps-user-add-001_51.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-052: fullname with i18n characters"
	rlLog "tps-user-add fullname Éric Têko with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName='Éric Têko' u27 > $TmpDir/pki-tps-user-add-001_52.out 2>&1" \
                    0 \
        ...
        rlAssertGrep "Full name: Éric Têko" "$TmpDir/pki-tps-user-add-001_52.out"
    rlPhaseEnd 

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-053: fullname with i18n characters"
	rlLog "tps-user-add fullname éénentwintig dvidešimt with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName='éénentwintig dvidešimt' u28 > $TmpDir/pki-tps-user-add-001_53.out 2>&1" \
                    0 \
        ...
        rlAssertGrep "Full name: éénentwintig dvidešimt" "$TmpDir/pki-tps-user-add-001_53.out"
        ...
        rlAssertGrep "Full name: éénentwintig dvidešimt" "$TmpDir/pki-tps-user-add-001_53_2.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-054: fullname with i18n characters"
	rlLog "tps-user-add fullname kakskümmend üks with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName='kakskümmend üks' u29 > $TmpDir/pki-tps-user-add-001_54.out 2>&1" \
                    0 \
                    "Adding fillname kakskümmend üks with i18n characters"
        rlAssertGrep "Added user \"u29\"" "$TmpDir/pki-tps-user-add-001_54.out"
        rlAssertGrep "Full name: kakskümmend üks" "$TmpDir/pki-tps-user-add-001_54.out"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
        ...
        rlAssertGrep "Full name: kakskümmend üks" "$TmpDir/pki-tps-user-add-001_54_2.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-055: fullname with i18n characters"
	rlLog "tps-user-add fullname двадцять один тридцять with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName='двадцять один тридцять' u30 > $TmpDir/pki-tps-user-add-001_55.out 2>&1" \
                    0 \
        ...
        rlAssertGrep "Full name: двадцять один тридцять" "$TmpDir/pki-tps-user-add-001_55.out"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
        ...
        rlAssertGrep "Full name: двадцять один тридцять" "$TmpDir/pki-tps-user-add-001_55_2.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-056: user id with i18n characters"
	rlLog "tps-user-add userid ÖrjanÄke with i18n characters"
        rlLog "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test 'ÖrjanÄke'"
        command="pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
	...
	rlLog "tps-user-add userid ÉricTêko with i18n characters"
        rlLog "pki -d $CERTDB_DIR \
 		   ...
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test 'ÉricTêko'"
        command="pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
	...
	rlLog "tps-user-add email address negyvenkettő@qetestsdomain.com with i18n characters"
	command="pki -d $CERTDB_DIR -n ${prefix}_adminV -c $CERTDB_DIR_PASSWORD -h $SUBSYSTEM_HOST -p $(eval echo \$${subsystemId}_UNSECURE_PORT) tps-user-add --fullName=test  --email='negyvenkettő@qetestsdomain.com' u31"
	...
	rlLog "tps-user-add email address četrdesmitdivi@qetestsdomain.com with i18n characters"
        command="pki -d $CERTDB_DIR -n ${prefix}_adminV  -c $CERTDB_DIR_PASSWORD -h $SUBSYSTEM_HOST -p $(eval echo \$${subsystemId}_UNSECURE_PORT) tps-user-add --fullName=test --email='četrdesmitdivi@qetestsdomain.com' u32"
        rlLog "Executing $command"
	...
	rlLog "tps-user-add password šimtaskolmkümmend with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test --password='šimtaskolmkümmend' u31 > $TmpDir/pki-tps-user-add-001_60.out 2>&1" \
                    0 \
	...
	rlLog "tps-user-add password двадцяттридцять with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test --password='двадцяттридцять' u32 > $TmpDir/pki-tps-user-add-001_61.out 2>&1" \
                    0 \
	...
	rlLog "tps-user-add type tjugo-tvåhetvenhét with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test --type='tjugo-tvåhetvenhét' u33 > $TmpDir/pki-tps-user-add-001_62.out 2>&1" \
                    0 \
                    "Adding type tjugo-tvåhetvenhét with i18n characters"
        rlAssertGrep "Added user \"u33\"" "$TmpDir/pki-tps-user-add-001_62.out"
	rlAssertGrep "Type: tjugo-tvåhetvenhét" "$TmpDir/pki-tps-user-add-001_62.out"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
	...
	rlAssertGrep "Type: tjugo-tvåhetvenhét" "$TmpDir/pki-tps-user-add-001_62_2.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-063: type with i18n characters"
	rlLog "tps-user-add type мiльйонтридцять with i18n characters"
	rlLog "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
                   -h $SUBSYSTEM_HOST \
                   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test --type='мiльйонтридцять' u34"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test --type='мiльйонтридцять' u34 > $TmpDir/pki-tps-user-add-001_63.out 2>&1" \
                    0 \
                    "Adding type мiльйонтридцять with i18n characters"
        rlAssertGrep "Added user \"u34\"" "$TmpDir/pki-tps-user-add-001_63.out"
        rlAssertGrep "Type: мiльйонтридцять" "$TmpDir/pki-tps-user-add-001_63.out"
	rlLog "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
                   -h $SUBSYSTEM_HOST \
        ...
        rlAssertGrep "Type: мiльйонтридцять" "$TmpDir/pki-tps-user-add-001_63_2.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-064: state with i18n characters"
	rlLog "tps-user-add state čå with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test --state='čå' u35 > $TmpDir/pki-tps-user-add-001_64.out 2>&1" \
                    0 \
                    "Adding state 'čå' with i18n characters"
        rlAssertGrep "Added user \"u35\"" "$TmpDir/pki-tps-user-add-001_64.out"
        rlAssertGrep "State: čå" "$TmpDir/pki-tps-user-add-001_64.out"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
        ...
        rlAssertGrep "State: čå" "$TmpDir/pki-tps-user-add-001_64_2.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tps_user_cli_tps_user_add-065: state with i18n characters"
	rlLog "tps-user-add state йč with i18n characters"
        ...
        rlRun "pki -d $CERTDB_DIR \
 		   ...
 		   -h $SUBSYSTEM_HOST \
 		   -p $(eval echo \$${subsystemId}_UNSECURE_PORT) \
                    tps-user-add --fullName=test --state='йč' u36 > $TmpDir/pki-tps-user-add-001_65.out 2>&1" \
                    0 \
                    "Adding state 'йč' with i18n characters"
        rlAssertGrep "Added user \"u36\"" "$TmpDir/pki-tps-user-add-001_65.out"
        rlAssertGrep "State: йč" "$TmpDir/pki-tps-user-add-001_65.out"
        rlRun "pki -d $CERTDB_DIR \
                   -n ${prefix}_adminV \
                   -c $CERTDB_DIR_PASSWORD \
 		   -h $SUBSYSTEM_HOST \
        ...
        rlAssertGrep "State: йč" "$TmpDir/pki-tps-user-add-001_65_2.out"
    rlPhaseEnd
