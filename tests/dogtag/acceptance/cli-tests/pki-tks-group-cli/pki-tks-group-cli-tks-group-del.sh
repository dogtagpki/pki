...
#   Description: PKI tks-group-del CLI tests
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# The following pki cli commands needs to be tested:
#  pki-tks-group-cli-tks-group-del   Delete pki subsystem groups.
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
...
run_pki-tks-group-cli-tks-group-del_tests(){

    rlPhaseStartSetup "pki_tks_group_cli_tks_group_del-startup: Create temporary directory"
...
ROOTCA_agent_user=${caId}_agentV
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-configtest-001: pki tks-group-del --help configuration test"
        rlRun "pki tks-group-del --help > $TmpDir/tks_group_del.out 2>&1" 0 "pki tks-group-del --help"
        rlAssertGrep "usage: tks-group-del <Group ID>" "$TmpDir/tks_group_del.out"
        rlAssertGrep "\--help   Show help options" "$TmpDir/tks_group_del.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-configtest-002: pki tks-group-del configuration test"
        rlRun "pki tks-group-del > $TmpDir/tks_group_del_2.out 2>&1" 255 "pki tks-group-del"
        rlAssertGrep "usage: tks-group-del <Group ID>" "$TmpDir/tks_group_del_2.out"
        rlAssertGrep " --help   Show help options" "$TmpDir/tks_group_del_2.out"
	rlAssertNotGrep "ResteasyIOException: IOException" "$TmpDir/tks_group_del_2.out"
    rlPhaseEnd

    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-003: Delete valid groups" 
	group1=tks_group
	...
	while [ $i -lt 25 ] ; do
	       rlLog "pki -d $CERTDB_DIR \
			  ...
			  -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-del  g$i > $TmpDir/pki-tks-group-del-group1-00$i.out" \
                           0 \
                           "Deleted group g$i"
		rlAssertGrep "Deleted group \"g$i\"" "$TmpDir/pki-tks-group-del-group1-00$i.out"
	   	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-show g$i"
        ...
        while [ $i -lt 8 ] ; do
	       eval grp=\$group$i
			   ...
			   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-add --description=test_group $grp"
                let i=$i+1
        done
        ...
        while [ $j -lt 8 ] ; do
	       ...
	       rlLog "pki -d $CERTDB_DIR \
			  ...
			  -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-del $grp > $TmpDir/pki-tks-group-del-group2-00$j.out" \
			   0 \
			   "Deleted group $grp"
		rlAssertGrep "Deleted group \"$grp\"" "$TmpDir/pki-tks-group-del-group2-00$j.out"
	   	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-show $grp"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-004: Case sensitive groupid"
	rlRun "pki -d $CERTDB_DIR \
			   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-add --description=test_group group_abc"
	rlRun "pki -d $CERTDB_DIR \
			   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-del GROUP_ABC > $TmpDir/pki-tks-group-del-group-002_1.out" \
                           0 \
	...
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-show group_abc"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-005: Delete group when required option group id is missing"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-006: Maximum length of group id"
	group2=$(openssl rand -hex 2048 |  perl -p -e 's/\n//')
        rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-add --description=test \"$group2\" > $TmpDir/pki-tks-group-add-001_1.out" \
                    0 \
	...
	rlRun "pki -d $CERTDB_DIR \
			   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-del \"$group2\" > $TmpDir/pki-tks-group-del-group-006.out" \
                           0 \
	...
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-show \"$group2\""
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-007: groupid with maximum length and symbols"
	...
	groupid=$(echo $rand_groupid | sed 's/\///g')
        rlRun "pki -d $CERTDB_DIR \
		    -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-add --description=test '$groupid' > $TmpDir/pki-tks-group-add-001_8.out" \
                    0 \
	...
	rlRun "pki -d $CERTDB_DIR \
			   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-del '$groupid' > $TmpDir/pki-tks-group-del-group-007.out" \
                           0 \
	...
	rlRun "pki -d $CERTDB_DIR \
			   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                           tks-group-show '$groupid'  > $TmpDir/pki-tks-group-del-group-007_2.out 2>&1" \
                           255 \
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-008: Delete group from TKS with -t option"
        rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                    -h $TKS_HOST \
                    -p $TKS_PORT \
		    -t tks \
                    tks-group-add --description=\"g1description\" g1 > $TmpDir/pki-tks-group-add-009.out" \
                    0 \
                    "Add group g1 to TKS"
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
	...
	rlAssertGrep "Deleted group \"g1\"" "$TmpDir/pki-tks-group-del-group-009.out"
        command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-show g1"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-009: Should not be able to delete group using a revoked cert TKS_adminR"
	#Add a group
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-add --description=\"g2description\" g2 > $TmpDir/pki-group-add-tks-010.out" \
                    0 \
                    "Add group g2 to TKS"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminR_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g2"
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-show g2 > $TmpDir/pki-tks-group-show-001.out" \
		    0 \
		    "Show group g2"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-010: Should not be able to delete group using a agent with revoked cert TKS_agentR"
	#Add a group
        rlRun "pki -d $CERTDB_DIR \
                   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-add --description=\"g3description\" g3 > $TmpDir/pki-group-add-tks-010.out" \
                    0 \
                    "Add group g3 to TKS"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_agentR_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g3"
	errmsg="PKIException: Unauthorized"
	errorcode=255
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-show g3 > $TmpDir/pki-tks-group-show-002.out" \
                    0 \
                    "Show group g3"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-011: Should not be able to delete group using a valid agent TKS_agentV user"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_agentV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g3"
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-show g3 > $TmpDir/pki-tks-group-show-003.out" \
                    0 \
                    "Show group g3"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-012: Should not be able to delete group using a admin user with expired cert TKS_adminE"
	#Set datetime 2 days ahead
        rlRun "date --set='+2 days'" 0 "Set System date 2 days ahead"
	rlRun "date"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminE_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g3"
	errmsg="ForbiddenException: Authorization Error" 
	errorcode=255
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-show g3 > $TmpDir/pki-group-show-tks-004.out" \
                    0 \
                    "Show group g3"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-013: Should not be able to delete a group using TKS_agentE cert"
	rlRun "date --set='+2 days'" 0 "Set System date 2 days ahead"
        rlRun "date"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_agentE_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g3"
	errmsg="ForbiddenException: Authorization Error"
	errorcode=255
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-014: Should not be able to delete group using a TKS_auditV"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_auditV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g3"
	errmsg="ForbiddenException: Authorization Error"
	errorcode=255
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-show g3 > $TmpDir/pki-group-show-tks-006.out" \
                    0 \
                    "Show group g3"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-015: Should not be able to delete group using a TKS_operatorV"
	command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_operatorV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g3"
	errmsg="ForbiddenException: Authorization Error"
	errorcode=255
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-show g3 > $TmpDir/pki-group-show-tks-007.out" \
                    0 \
                    "Show group g3"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-016: Should not be able to delete group using a cert created from a untrusted CA TKS_adminUTCA"
	command="pki -d $UNTRUSTED_CERT_DB_LOCATION -n role_user_UTCA -c $UNTRUSTED_CERT_DB_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-del g3"
	errmsg="PKIException: Unauthorized"
	errorcode=255
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    ...
                    -h $TKS_HOST \
                    -p $TKS_PORT \
                    tks-group-show g3 > $TmpDir/pki-group-show-tks-008.out" \
                    0 \
                    "Show group g3"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-017: Should not be able to delete group using a user cert"
	#Create a user cert
        ...
        rlRun "pki -d $TEMP_NSS_DB \
                   ...
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-del g3 >  $TmpDir/pki-tks-group-del-pkiUser1-0025.out 2>&1" 255 "Should not be able to find groups using a user cert"
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                   ...
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-show g3 > $TmpDir/pki-group-show-tks-009.out" \
                    0 \
                    "Show group g3"
	...
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                   ...
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-del g3 > $TmpDir/pki-group-del-tks-018.out 2>&1"
    rlPhaseEnd

    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-018: delete group id with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
		    -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-add --description=test 'ÖrjanÄke' > $TmpDir/pki-group-add-tks-001_19.out 2>&1" \
                    0 \
	...
	rlLog "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                   ...
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-del 'ÖrjanÄke'"
        rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-del 'ÖrjanÄke' > $TmpDir/pki-group-del-tks-001_19_3.out 2>&1" \
                    0 \
                    "Deleted gid ÖrjanÄke with i18n characters"
	rlAssertGrep "Deleted group \"ÖrjanÄke\""  "$TmpDir/pki-group-del-tks-001_19_3.out"
        command="pki -d $CERTDB_DIR -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-show 'ÖrjanÄke'"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del-019: delete groupid with i18n characters"
        rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-add --description=test 'ÉricTêko' > $TmpDir/pki-group-add-tks-001_20.out 2>&1" \
                    0 \
        ...
        rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                   ...
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-show 'ÉricTêko' > $TmpDir/pki-group-add-tks-001_20_2.out" \
                    0 \
                    "Show group 'ÉricTêko'"
	...
	rlLog "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                   ...
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-del 'ÉricTêko'"
	rlRun "pki -d $CERTDB_DIR \
		   -n $(eval echo \$${subsystemId}_adminV_user) \
                    -c $CERTDB_DIR_PASSWORD \
                   -h $TKS_HOST \
                   -p $TKS_PORT \
                    tks-group-del 'ÉricTêko' > $TmpDir/pki-group-del-tks-001_20_3.out 2>&1" \
                    0 \
                    "Delete gid ÉricTêko with i18n characters"
	rlAssertGrep "Deleted group \"ÉricTêko\""  "$TmpDir/pki-group-del-tks-001_20_3.out"
        command="pki -d $CERTDB_DIR  -n $(eval echo \$${subsystemId}_adminV_user) -c $CERTDB_DIR_PASSWORD -h $TKS_HOST -p $TKS_PORT tks-group-show 'ÉricTêko'"
    ...
    rlPhaseStartTest "pki_tks_group_cli_tks_group_del_cleanup-004: Deleting the temp directory"
        rlRun "popd"
        rlRun "rm -r $TmpDir" 0 "Removing tmp directory"
    rlPhaseEnd
else
        rlPhaseStartCleanup "pki tks-group-del cleanup: Delete temp dir"
        rlRun "popd"
        rlRun "rm -r $TmpDir" 0 "Removing tmp directory"
