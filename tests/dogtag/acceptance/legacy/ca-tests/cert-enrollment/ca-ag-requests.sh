...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
#   runtest.sh of /CoreOS/rhcs/acceptance/legacy/ca-tests/cert-enrollment/ca-ag-requests
#   Description: CA Agent Requests 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
run_ca-ag-requests_tests()
{
	...
	rlPhaseStartTest "pki_ca_ag-requests-001: CA Agent Page: List Requests try to display 100 requests and their details"
	...
	rlPhaseStartTest "pki_ca_ag-requests-002: CA Agent Page: view a particular profile based certificate request"
	...
	rlPhaseStartTest "pki_ca_ag-requests-003: CA Agent Page: Approve Profile request"
        local request_type=pkcs10
        local request_key_type=rsa
        local request_key_size=1024
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_ca_ag-requests-004: CA Agent Page: Cancel Certificate request"	
        local request_type=pkcs10
        local request_key_type=rsa
        local request_key_size=1024
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_ca_ag-requests-005: CA Agent Page: Reject Certificate request"
        local request_type=pkcs10
        local request_key_type=rsa
        local request_key_size=1024
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_ca_ag-requests-006: CA Agent Page: Assign Certificate request"
        local request_type=pkcs10
        local request_key_type=rsa
        local request_key_size=1024
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_ca_ag-requests-007: CA Agent Page: UnAssign Certificate request"
        local request_type=pkcs10
        local request_key_type=rsa
        local request_key_size=1024
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_ca_ag-requests-008: CA Agent Page: Validate Certificate request"
        local request_type=pkcs10
        local request_key_type=rsa
        local request_key_size=1024
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_ca_ag-requests-009: CA Agent Page: Update Certificate request"
        local request_type=pkcs10
        local request_key_type=rsa
        local request_key_size=1024
        local profile=caUserCert
	...
	rlPhaseStartTest "pki_ca_ag-requests-0010: Search certs with serial Number range"
	local maxCount=10
	...
	local basicConstraintsInUse=''
        ...
        rlPhaseStartTest "pki_ca_ag-requests-0011: Search certs with status VALID"
        local maxCount=10
        local test_out=srcCerts.txt
        local op=srchCerts
        ...
        rlPhaseStartTest "pki_ca_ag-requests-0012: Search certs with status REVOKED"
        local maxCount=10
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseStartSetup "pki_ca_ag-requests-0013: Generate a profile which generates cert with 1 day validity period"
	...
	local PKIDAEMON_STATUS="/tmp/pkidaemon-status"
	local cur_date=$(date)
	...
	rlRun "/usr/bin/systemctl stop pki-tomcatd@$tomcat_name\.service" 0 "Stop $tomcat_name service"
	rlRun "/usr/bin/pkidaemon status tomcat $tomcat_name 1> $PKIDAEMON_STATUS" 3 "Verify $tomcat_name is stopped"
	rlAssertGrep "Status for $tomcat_name: $tomcat_name is stopped" "$PKIDAEMON_STATUS"
	rlRun "/usr/bin/systemctl start pki-tomcatd@$tomcat_name\.service"
        RETVAL=$?
        if [ $RETVAL != 0 ]; then
                rlLog "Could not start $tomcat_name service"
                return 1
        fi
        #Verify pki-tomcat service 
        rlRun "/usr/bin/pkidaemon status tomcat $tomcat_name 1> $PKIDAEMON_STATUS"
        # Verify checks 
        rlAssertGrep "Status for $tomcat_name: $tomcat_name is running" "$PKIDAEMON_STATUS"
	rlRun "sleep 30"
	...
	rlPhaseStartTest "pki_ca_ag-requests-0014: Search certs with status EXPIRED"
        local maxCount=10
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseEnd
        ...
        rlPhaseStartTest "pki_ca_ag-requests-0015: Search certs with subject Name"
        local maxCount=1
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseEnd
        ...
        rlPhaseStartTest "pki_ca_ag-requests-0016: Search certs with status REVOKED by Agent"
        local maxCount=10
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseEnd
        ...
        rlPhaseStartTest "pki_ca_ag-requests-0017: Search certs with status REVOKED with reason unspecified"
        local maxCount=10
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseEnd
        ...
        rlPhaseStartTest "pki_ca_ag-requests-0018: Search certs issued by valid agent"
        local maxCount=10
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseEnd
        ...
        rlPhaseStartTest "pki_ca_ag-requests-0019: Search certs with validity period of 1 day"
        local maxCount=1
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseStartTest "pki_ca_ag-requests-0020: Search certs with Basic Contraints"
        local maxCount=1
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
	...
	rlPhaseStartTest "pki_ca_ag-requests-0021: Search certs of type SSLCLient"
        local maxCount=0
        local test_out=srcCerts.txt
        local op=srchCerts
        local serialNumberRangeInUse=''
