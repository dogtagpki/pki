 ...
 */
public class SigningKeyGenInput extends EnrollInput {

    public static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(SigningKeyGenInput.class);
    ...
    public void populate(Map<String, String> ctx, IRequest request) throws Exception {
        ...
        if (keygen_request_type == null) {
            logger.error("SigningKeyGenInput: populate - invalid cert request type");
        ...
        if (keygen_request == null) {
            logger.error("SigningKeyGenInput: populate - invalid certificate request");
        ...
        if (keygen_request_type.startsWith(EnrollProfile.REQ_TYPE_PKCS10)) {
            ...
            logger.error("SigningKeyGenInput: populate - invalid cert request type " + keygen_request_type);
            throw new EProfileException(CMS.getUserMessage(
                        getLocale(request),
                        "CMS_PROFILE_UNKNOWN_CERT_REQ_TYPE",
                        keygen_request_type));
