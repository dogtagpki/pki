 ...
 */
public class EncryptionKeyGenInput extends EnrollInput {

    public static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(EncryptionKeyGenInput.class);
    ...
    public void populate(Map<String, String> ctx, IRequest request) throws Exception {
        ...
        if (keygen_request_type == null) {
            logger.error("EncryptionKeyGenInput: populate - invalid cert request type");
