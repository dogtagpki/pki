 ...
 */
public abstract class SubsystemIdGeneratorUpdateCLI extends CommandCLI {
    ...
    private EngineConfig getEngineConfig(String subsystem) throws Exception {
    ...
    private LdapAuthInfo getAuthInfo(IPasswordStore passwordStore, LdapConnInfo connInfo, LDAPConfig ldapConfig)
    ...
    private String getSecurePort(EngineConfig config) throws Exception {
