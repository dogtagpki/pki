...
public class AuthToken implements IAuthToken {
    ...
    public AuthToken(AuthManager authMgr) {
        ...
        if (authMgr != null) {
            set(AuthToken.TOKEN_AUTHMGR_INST_NAME, authMgr.getName());
        }
        set(AuthToken.TOKEN_AUTHTIME, new Date());
    }
    ...
    public String getAuthManagerInstName() {
        return ((String) mAttrs.get(AuthToken.TOKEN_AUTHMGR_INST_NAME));
    }
    ...
    public Date getAuthTime() {
        return ((Date) mAttrs.get(AuthToken.TOKEN_AUTHTIME));
    }
}
