...
public abstract class AbstractPKIAuthenticator extends AuthenticatorBase {
    ...
    public AbstractPKIAuthenticator() {
        logger.info("PKIAuthenticator: Creating PKI authenticator");
    }
        ...
        if (certs != null && certs.length > 0) {
            ...
            HttpServletResponseWrapper wrapper = new HttpServletResponseWrapper(response) {
                public void setHeader(String name, String value) {
                    logger.fine("PKIAuthenticator: ASSL auth header: " + name + "=" + value);
                };
                public void sendError(int code) {
                    logger.fine("PKIAuthenticator: ASSL auth return code: " + code);
                }
            };
    ...
    public void setContainer(Container container) {
        logger.info("PKIAuthenticator: Setting container");
    ...
    protected void initInternal() throws LifecycleException {
        logger.info("PKIAuthenticator: Initializing authenticators");
    ...
    public void startInternal() throws LifecycleException {
        logger.info("PKIAuthenticator: Starting authenticators");
        super.startInternal();
    ...
    public void stopInternal() throws LifecycleException {
        logger.info("PKIAuthenticator: Stopping authenticators");
        super.stopInternal();
