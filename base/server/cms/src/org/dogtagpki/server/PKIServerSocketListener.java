...
public class PKIServerSocketListener implements SSLSocketListener {
    ...
    public void alertSent(SSLAlertEvent event) {
        try {
            ...
            String subjectID = subjectDN == null ? null : subjectDN.toString();
            ...
            } else if (description == SSLAlertDescription.BAD_CERTIFICATE.getID() || description == SSLAlertDescription.HANDSHAKE_FAILURE.getID()) {
