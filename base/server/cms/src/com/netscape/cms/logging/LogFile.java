...
public class LogFile implements ILogEventListener, IExtendedPluginInfo {
    ...
    public void log(ILogEvent ev) throws ELogException {
        ...
        if (mType.equals("signedAudit")) {
            if (ev instanceof SignedAuditEvent) {
                logSignedAuditEvent((SignedAuditEvent)ev);
            }
            return;
        }

        CMS.debug("LogFile: logger type not supported: " + mType);
    }

    public void logSignedAuditEvent(SignedAuditEvent ev) throws ELogException {
