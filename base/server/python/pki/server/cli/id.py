...
class IdGeneratorCLI(pki.cli.CLI):
    ...
    def __init__(self, parent):
        super(IdGeneratorCLI, self).__init__('generator',
...
class IdGeneratorShowCLI(pki.cli.CLI):
    ...
    def __init__(self, parent):
        super(IdGeneratorShowCLI, self).__init__('show', 'Display %s id generator' % parent.parent.parent.name.upper())
...
class IdGeneratorUpdateCLI(pki.cli.CLI):
    ...
    def __init__(self, parent):
        super(IdGeneratorUpdateCLI, self).__init__('update', 'Update %s id generator' % parent.parent.parent.name.upper())
    ...
    def print_help(self):
        ...
        print('  -t, --type <generator type>      Type of generator to use (only legacy2 supported).')
