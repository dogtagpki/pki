...
public class CMSEngine implements ICMSEngine {
    ...
    protected Map<String, SubsystemInfo> staticSubsystems = new LinkedHashMap<>();

    // dynamic subsystems are loaded at init time, not necessarily singletons.
    protected Map<String, SubsystemInfo> dynSubsystems = new LinkedHashMap<>();

    // final static subsystems - must be singletons.
    protected Map<String, SubsystemInfo> finalSubsystems = new LinkedHashMap<>();
