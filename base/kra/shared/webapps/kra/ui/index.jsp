...
<head>
    ...
    <script src="/kra/js/keyrequest.js"></script>
    <script>
$(function() {
    ...
    router.route("keyrequests", "keyrequests", function() {
        new KeyRequestsPage({
            el: content,
            url: "keyrequests.html",
            collection: new KeyRequestCollection()
        }).open();
    });

    router.route("keyrequests/:id", "keyrequest", function(id) {
        new KeyRequestPage({
            el: content,
            url: "keyrequest.html",
            model: new KeyRequestModel({ id: id })
        }).open();
    });
    ...
    router.route("users/:id/roles", "user-roles", function(id) {
        new UserRolesPage({
            ...
            collection: new UserRoleCollection(null, {
                userID: id,
                urlRoot: "/kra/rest/admin/users/" + id + "/memberships"
            })
        }).open();
    });
    ...
    router.route("users/:id/certs", "user-certs", function(id) {
        new UserCertsPage({
            ...
            collection: new UserCertCollection(null, {
                userID: id,
                urlRoot: "/kra/rest/admin/users/" + id + "/certs"
            })
        }).open();
    });
    ...
    var account = new Account("/kra/rest/account");
...
-->
    ...
    <li name="keyrequests"><a href="#keyrequests">Requests</a></li>
