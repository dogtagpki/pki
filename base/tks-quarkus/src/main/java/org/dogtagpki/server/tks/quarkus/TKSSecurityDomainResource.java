...
/**
 * JAX-RS resource for TKS security domain operations.
 * Replaces SecurityDomainServlet from base server.
 */
@Path("v2/securityDomain")
public class TKSSecurityDomainResource {

    private static final Logger logger = LoggerFactory.getLogger(TKSSecurityDomainResource.class);
    ...
    public Response getInstallToken(
        ...
        logger.debug("TKSSecurityDomainResource.getInstallToken(): hostname={}, subsystem={}", hostname, subsystem);
    ...
    public Response getDomainInfo() throws Exception {
        logger.debug("TKSSecurityDomainResource.getDomainInfo()");
    ...
    public Response getHosts() throws Exception {
        logger.debug("TKSSecurityDomainResource.getHosts()");
    ...
    public Response getHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("TKSSecurityDomainResource.getHost(): hostId={}", hostId);
    ...
    public Response addHost(String requestData) throws Exception {
        logger.debug("TKSSecurityDomainResource.addHost()");
    ...
    public Response removeHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("TKSSecurityDomainResource.removeHost(): hostId={}", hostId);
