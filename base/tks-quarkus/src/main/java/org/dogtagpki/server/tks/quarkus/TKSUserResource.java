...
/**
 * JAX-RS resource for TKS user operations.
 * Replaces TKSUserServlet.
 */
@Path("v2/admin/users")
public class TKSUserResource {

    private static final Logger logger = LoggerFactory.getLogger(TKSUserResource.class);
