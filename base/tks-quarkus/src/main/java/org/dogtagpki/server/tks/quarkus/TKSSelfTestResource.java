...
/**
 * JAX-RS resource for TKS self-test operations.
 * Replaces TKSSelfTestServlet.
 */
@Path("v2/selftests")
public class TKSSelfTestResource {

    private static final Logger logger = LoggerFactory.getLogger(TKSSelfTestResource.class);
    ...
    public Response findSelfTests(
        ...
        logger.debug("TKSSelfTestResource.findSelfTests()");
    ...
    public Response getSelfTest(@PathParam("testId") String testId) throws Exception {
        logger.debug("TKSSelfTestResource.getSelfTest(): testId={}", testId);
    ...
    public Response executeSelfTests(@QueryParam("action") String action) throws Exception {
        logger.debug("TKSSelfTestResource.executeSelfTests(): action={}", action);
    ...
    public Response runSelfTests() throws Exception {
        logger.debug("TKSSelfTestResource.runSelfTests()");
