 ...
 * Replaces TKSAuditServlet.
 */
@Path("v2/audit")
public class TKSAuditResource {

    private static final Logger logger = LoggerFactory.getLogger(TKSAuditResource.class);
    ...
    public Response findAuditFiles() throws Exception {
        logger.debug("TKSAuditResource.findAuditFiles()");
