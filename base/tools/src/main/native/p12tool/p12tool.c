...
/* This file and the rest of this tool is heavily based on the nss
 * tool "pk12util". This file is from: cmd/pk12util/pk12util.c, in
 * the nss source tree.
 *
 * The new file: moreoids.c was added to support new. AES_KEY_WRAP_KWP oids.
 * This file p12tools.c has been  modifed to call SECU_RegisterDynamicOids() provided in moreoids.c,
 * which actually registers these new OIDS dynamically into nss.
 */
