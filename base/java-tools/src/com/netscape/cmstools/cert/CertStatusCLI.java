...
public class CertStatusCLI extends CLI {
    ...
    public void execute(String[] args) throws Exception {
        ...
        AuthoritySearchRequest authoritySearchRequest = new AuthoritySearchRequest();
        authoritySearchRequest.setDN(issuerDN);

        AuthoritySearchResponse authoritySearchResponse = authorityClient.findCAs(authoritySearchRequest);

        Collection<AuthorityData> authorities = authoritySearchResponse.getEntries();
