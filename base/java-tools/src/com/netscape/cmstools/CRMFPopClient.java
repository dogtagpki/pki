...
public class CRMFPopClient {
    ...
    public static void main(String args[]) throws Exception {
        ...
        if (cmd.hasOption("g")) {
            keyWrap = Boolean.parseBoolean(cmd.getOptionValue("g", "true"));
        } else {
            String archivalMechanism = System.getenv("KEY_WRAP_ARCHIVAL_MECHANISM");
            if (archivalMechanism != null) {
                keyWrap = archivalMechanism.equalsIgnoreCase(KRAInfoResource.KEYWRAP_MECHANISM);
            }
        }
