...
$(function() {
    ...
    router.route("users/:id/roles", "user-roles", function(id) {
        new UserRolesPage({
            ...
            collection: new UserRoleCollection(null, {
                userID: id,
                urlRoot: "/tks/rest/admin/users/" + id + "/memberships"
            })
        }).open();
    });
    ...
    router.route("users/:id/certs", "user-certs", function(id) {
        new UserCertsPage({
            ...
            collection: new UserCertCollection(null, {
                userID: id,
                urlRoot: "/tks/rest/admin/users/" + id + "/certs"
            })
        }).open();
    });
    ...
    var account = new Account("/tks/rest/account");
