...
public class PKCS12Util {
    ...
    public void addKeyBag(PKCS12KeyInfo keyInfo, Password password,
        ...
        if (epkiBytes != null) {
            ...
            if (keyEncryption == PBEAlgorithm.PBE_SHA1_DES3_CBC) {
                ...
                content = create_EPKIwithPBE_PKCS5_PBES2(token, privateKey, password);
    ...
    public ASN1Value create_EPKI_with_PBE_SHA1_DES3_CBC(CryptoToken token, PrivateKey privateKey, Password password)
        ...
        // The salt size and number of iterations are selected to match pk12util.
    ...
    public ASN1Value create_EPKIwithPBE_PKCS5_PBES2(CryptoToken token, PrivateKey privateKey, Password password)
            throws Exception {
