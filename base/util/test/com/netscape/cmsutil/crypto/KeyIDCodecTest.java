 ...
 *
 * Key ID in NSS database is 20-byte long. The key ID is
 * stored in CS.cfg as signed, variable-length, hexadecimal
 * number.
 *
 * This test verifies that Key ID can be encoded and
 * decoded correctly using the following methods:
 *  - CryptoUtil.byte2string()
 *  - CryptoUtil.string2byte()
 *
 *  The test is performed against a known set of data that
 *  covers the entire range of 20-byte number.
 */
public class KeyIDCodecTest {
    ...
    public void testEncoder() throws Exception {
        ...
        System.out.println("Testing Key ID encoder:");
        ...
        for (int i = 0; i < TEST_DATA.length; i++) {
            ...
            String result = CryptoUtil.byte2string(bytes);
    ...
    public void testDecoder() throws Exception {
        ...
        System.out.println("Testing Key ID decoder:");
        ...
        for (int i = 0; i < TEST_DATA.length; i++) {
            ...
            byte[] result = CryptoUtil.string2byte(hex);
