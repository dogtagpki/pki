...
$(function() {
    ...
    router.route("users/:id/roles", "user-roles", function(id) {
        new UserRolesPage({
            ...
            collection: new UserRoleCollection(null, {
                userID: id,
                urlRoot: "/ocsp/rest/admin/users/" + id + "/memberships"
            })
        }).open();
    });
    ...
    router.route("users/:id/certs", "user-certs", function(id) {
        new UserCertsPage({
            ...
            collection: new UserCertCollection(null, {
                userID: id,
                urlRoot: "/ocsp/rest/admin/users/" + id + "/certs"
            })
        }).open();
    });
    ...
    router.route("groups", "groups", function() {
        new GroupsPage({
            ...
            collection: new GroupCollection(null, {
                urlRoot: "/ocsp/rest/admin/groups"
            }),
    ...
    var account = new Account("/ocsp/rest/account");
...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="/ocsp">
        <b>OCSP Manager</b>
    </a>
</div>
