...
/**
 * JAX-RS resource for KRA security domain operations.
 * Replaces KRASecurityDomainServlet.
 */
@Path("v2/securityDomain")
public class KRASecurityDomainResource {

    private static final Logger logger = LoggerFactory.getLogger(KRASecurityDomainResource.class);
    ...
    public Response getInstallToken(
        ...
        logger.debug("KRASecurityDomainResource.getInstallToken(): hostname={}, subsystem={}", hostname, subsystem);
    ...
    public Response getDomainInfo() throws Exception {
        logger.debug("KRASecurityDomainResource.getDomainInfo()");
    ...
    public Response getHosts() throws Exception {
        logger.debug("KRASecurityDomainResource.getHosts()");
    ...
    public Response getHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("KRASecurityDomainResource.getHost(): hostId={}", hostId);
    ...
    public Response addHost(String requestData) throws Exception {
        logger.debug("KRASecurityDomainResource.addHost()");
    ...
    public Response removeHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("KRASecurityDomainResource.removeHost(): hostId={}", hostId);
