...
/**
 * JAX-RS resource for OCSP security domain operations.
 * Replaces OCSPSecurityDomainServlet.
 */
@Path("v2/securityDomain")
public class OCSPSecurityDomainResource {

    private static final Logger logger = LoggerFactory.getLogger(OCSPSecurityDomainResource.class);
    ...
    public Response getInstallToken(
        ...
        logger.debug("OCSPSecurityDomainResource.getInstallToken(): hostname={}, subsystem={}", hostname, subsystem);
    ...
    public Response getDomainInfo() throws Exception {
        logger.debug("OCSPSecurityDomainResource.getDomainInfo()");
    ...
    public Response getHosts() throws Exception {
        logger.debug("OCSPSecurityDomainResource.getHosts()");
    ...
    public Response getHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("OCSPSecurityDomainResource.getHost(): hostId={}", hostId);
    ...
    public Response addHost(String requestData) throws Exception {
        logger.debug("OCSPSecurityDomainResource.addHost()");
    ...
    public Response removeHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("OCSPSecurityDomainResource.removeHost(): hostId={}", hostId);
