...
@WebServlet(
        name = "caProfileSubmitCMCFullSubsystemCert",
        urlPatterns = "/ee/ca/profileSubmitCMCFullSubsystemCert",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caCMCsubsystemCert"),
...
public class ProfileSubmitCMCFullSubsystemServlet extends ProfileSubmitCMCServlet {
