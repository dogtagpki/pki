...
@WebServlet(
        name = "caProfileSubmitCMCFullKRATransportCert",
        urlPatterns = "/ee/ca/profileSubmitCMCFullKRAtransportCert",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caCMCkraTransportCert"),
...
public class ProfileSubmitCMCFullKRATransportServlet extends ProfileSubmitCMCServlet {
