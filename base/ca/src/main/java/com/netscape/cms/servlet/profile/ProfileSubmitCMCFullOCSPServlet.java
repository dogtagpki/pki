...
@WebServlet(
        name = "caProfileSubmitCMCFullOCSPCert",
        urlPatterns = "/ee/ca/profileSubmitCMCFullOCSPCert",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caCMCocspCert"),
...
public class ProfileSubmitCMCFullOCSPServlet extends ProfileSubmitCMCServlet {
