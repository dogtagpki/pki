...
@WebServlet(
        name = "caProfileSubmitCMCFullAuditSigningCert",
        urlPatterns = "/ee/ca/profileSubmitCMCFullAuditSigningCert",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caCMCauditSigningCert"),
...
public class ProfileSubmitCMCFullAuditSigningServlet extends ProfileSubmitCMCServlet {
