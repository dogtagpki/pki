...
@WebServlet(
        name = "caProfileSubmitCMCFull",
        urlPatterns = "/ee/ca/profileSubmitCMCFull",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caFullCMCUserCert"),
...
public class ProfileSubmitCMCFullServlet extends ProfileSubmitCMCServlet {
