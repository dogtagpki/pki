...
@WebServlet(
        ...
        urlPatterns = "/ee/ca/profileSubmitCMCFullKRAstorageCert",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caCMCkraStorageCert"),
...
public class ProfileSubmitCMCFullKRAStorageServlet extends ProfileSubmitCMCServlet {
