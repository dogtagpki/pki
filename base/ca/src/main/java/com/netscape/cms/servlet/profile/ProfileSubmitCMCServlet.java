...
public class ProfileSubmitCMCServlet extends ProfileServlet {
    ...
    private void setCredentialsIntoContext(HttpServletRequest request, AuthManager authenticator,
    ...
    public void process(CMSRequest cmsReq) throws EBaseException {
        ...
        if (authenticator != null) {
            ...
            if (authToken != null) {
                ...
                // CMCAuth and CMCAuthForEST should pair with additional authz check as they count
                // as pre-approved
                String authMgrID = authenticator.getName();
                if (authMgrID.equals("CMCAuth") || authMgrID.equals("CMCAuthForEST")) {
