...
@WebServlet(
        name = "caProfileSubmitUserSignedCMCFull",
        urlPatterns = "/ee/ca/profileSubmitUserSignedCMCFull",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caFullCMCUserSignedCert"),
                @WebInitParam(name="AuthzMgr",          value="BasicAclAuthz"),
                @WebInitParam(name="authorityId",       value="ca"),
                @WebInitParam(name="ID",                value="caProfileSubmitUserSignedCMCFull"),
...
public class ProfileSubmitUserSignedCMCFullServlet extends ProfileSubmitCMCServlet {
