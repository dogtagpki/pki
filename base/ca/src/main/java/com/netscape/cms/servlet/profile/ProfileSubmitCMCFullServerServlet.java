...
@WebServlet(
        name = "caProfileSubmitCMCFullServerCert",
        urlPatterns = "/ee/ca/profileSubmitCMCFullServerCert",
        initParams = {
                @WebInitParam(name="GetClientCert",     value="false"),
                @WebInitParam(name="cert_request_type", value="cmc"),
                @WebInitParam(name="profileId",         value="caCMCserverCert"),
...
public class ProfileSubmitCMCFullServerServlet extends ProfileSubmitCMCServlet {
