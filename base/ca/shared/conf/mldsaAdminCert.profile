#
# ML-DSA Admin Certificate
#
id=adminCert.profile
name=All Purpose admin cert with ML-DSA keys Profile
description=This profile creates an administrator's certificate with ML-DSA keys
