...
public class TPSMessage {
    ...
    protected Op_Type intToOpType(int i) {
        Op_Type result = Op_Type.OP_UNDEFINED;
        ...
        case 0:
            result = Op_Type.OP_UNDEFINED;
        case 1:
            result = Op_Type.OP_ENROLL;
            break;
        case 2:
            result = Op_Type.OP_UNBLOCK;
            break;
        case 3:
            result = Op_Type.OP_RESET_PIN;
            break;
        case 4:
            result = Op_Type.OP_RENEW;
            break;
        case 5:
            result = Op_Type.OP_FORMAT;
            break;
        default:
            result = Op_Type.OP_UNDEFINED;
            break;
    ...
    protected int opTypeToInt(Op_Type op) {
        int result = 0;
    ...
    protected Msg_Type intToMsgType(int i) {

        Msg_Type result = Msg_Type.MSG_UNDEFINED;
        ...
        switch (i) {
        case 2:
            result = Msg_Type.MSG_BEGIN_OP;
            break;
        case 3:
            result = Msg_Type.MSG_LOGIN_REQUEST;
            break;
        case 4:
            result = Msg_Type.MSG_LOGIN_RESPONSE;
            break;
        case 5:
            result = Msg_Type.MSG_SECUREID_REQUEST;
            break;
        case 6:
            result = Msg_Type.MSG_SECUREID_RESPONSE;
            break;
        case 7:
            result = Msg_Type.MSG_ASQ_REQUEST;
            break;
        case 8:
            result = Msg_Type.MSG_ASQ_RESPONSE;
            break;
        case 9:
            result = Msg_Type.MSG_TOKEN_PDU_REQUEST;
            break;
        case 10:
            result = Msg_Type.MSG_TOKEN_PDU_RESPONSE;
            break;
        case 11:
            result = Msg_Type.MSG_NEW_PIN_REQUEST;
            break;
        case 12:
            result = Msg_Type.MSG_NEW_PIN_RESPONSE;
            break;
        case 13:
            result = Msg_Type.MSG_END_OP;
            break;
        case 14:
            result = Msg_Type.MSG_STATUS_UPDATE_REQUEST;
            break;
        case 15:
            result = Msg_Type.MSG_STATUS_UPDATE_RESPONSE;
            break;
        case 16:
            result = Msg_Type.MSG_EXTENDED_LOGIN_REQUEST;
            break;
        case 17:
            result = Msg_Type.MSG_EXTENDED_LOGIN_RESPONSE;
            break;

        default:
            result = Msg_Type.MSG_UNDEFINED;
            break;
        }
    ...
    protected int msgTypeToInt(Msg_Type type) {
    ...
    private TPSMessage createMessage() {
        ...
        Msg_Type val = intToMsgType(msg_type_int);
        Op_Type op_val = intToOpType(op_type_int);
