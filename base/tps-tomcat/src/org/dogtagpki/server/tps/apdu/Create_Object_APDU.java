...
public class Create_Object_APDU extends APDU {
    /**
    ...
    public Create_Object_APDU(byte[] object_id, byte[] permissions, int len) {
    ...
    public APDU.APDU_Type GetType() {
        return APDU.APDU_Type.APDU_CREATE_OBJECT;
    ...
    public static void main(String args[]) {
        ...
        Create_Object_APDU apdu = new Create_Object_APDU(object_id, permisisons, 56);
