...
public class Install_Applet_APDU extends APDU {

    public Install_Applet_APDU(TPSBuffer packageAID, TPSBuffer appletAID,
     ...
     */
    public Install_Applet_APDU(TPSBuffer data)
    {
        SetCLA((byte) 0x84);
        SetINS((byte) 0xE6);
        SetP1((byte) 0x0C);
    ...
    {
        return APDU_Type.APDU_INSTALL_APPLET;
    }
