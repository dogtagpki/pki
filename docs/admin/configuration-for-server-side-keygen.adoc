...
policyset.userCertSet.3.constraint.params.allowedKeys.RSA.1024=true
policyset.userCertSet.3.constraint.params.allowedKeys.RSA.2048=true
policyset.userCertSet.3.constraint.params.allowedKeys.RSA.3072=true
policyset.userCertSet.3.constraint.params.allowedKeys.RSA.4096=true
policyset.userCertSet.3.constraint.params.allowedKeys.EC.nistp256=true
policyset.userCertSet.3.constraint.params.allowedKeys.EC.nistp384=true
policyset.userCertSet.3.constraint.params.allowedKeys.EC.nistp521=true
