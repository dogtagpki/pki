...
To generate a certificate request and submit it to CA, see link:Submitting-Certificate-Request-with-Key-Archival[Submitting Certificate Request with Key Archival].
