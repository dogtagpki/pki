...
[NOTE]
====
This guide supports two deployment options:

* **Non-PQC Deployment (RSA Device Certificates)**: Standard RSA-based CA that issues RSA device certificates via EST
* **PQC Deployment (ML-DSA Device Certificates)**: ML-DSA-65 CA that issues ML-DSA device certificates via EST

The configuration steps will indicate where the options differ.
====
...
==== Non-PQC Deployment: RSA Device Certificates
...
==== PQC Deployment: ML-DSA-65 Device Certificates
Create `/root/dogtag/pki-ca/ca.cfg`:
...
pki_admin_key_size=65
pki_admin_key_algorithm=ML-DSA-65
...
pki_ca_signing_key_algorithm=ML-DSA-65
pki_ca_signing_key_size=65
pki_ca_signing_signing_algorithm=ML-DSA-65

pki_ocsp_signing_nickname=ca_ocsp_signing
pki_ocsp_signing_key_type=mldsa
pki_ocsp_signing_key_algorithm=ML-DSA-65
pki_ocsp_signing_key_size=65
pki_ocsp_signing_signing_algorithm=ML-DSA-65

pki_audit_signing_nickname=ca_audit_signing
pki_audit_signing_key_type=mldsa
pki_audit_signing_key_algorithm=ML-DSA-65
pki_audit_signing_key_size=65
pki_audit_signing_signing_algorithm=ML-DSA-65

pki_sslserver_nickname=sslserver
pki_sslserver_key_type=mldsa
pki_sslserver_key_algorithm=ML-DSA-65
pki_sslserver_key_size=65
pki_sslserver_signing_algorithm=ML-DSA-65

pki_subsystem_nickname=subsystem
pki_subsystem_key_type=mldsa
pki_subsystem_key_algorithm=ML-DSA-65
pki_subsystem_key_size=65
pki_subsystem_signing_algorithm=ML-DSA-65
----
...
==== PQC Deployment: Configure ML-DSA Device Certificate Profile

For ML-DSA device certificate enrollment, create and enable the ML-DSA profile:

. Create `/var/lib/pki/pki-ca/ca/profiles/ca/estFullcmcMLDSADeviceCert.cfg`:
+
[source,bash]
----
profileId=estFullcmcMLDSADeviceCert
auth.instance_id=CMCAuthForEST
desc=This certificate profile is for enrolling ML-DSA device certificates by using CMC certificate request via EST fullcmc. Agents can request any subject name; non-agents are restricted to their own certificate subject.
enable=true
enableBy=caadmin
input.i1.class_id=cmcCertReqInputImpl
input.list=i1
name=CMC-Authenticated ML-DSA Device Certificate Enrollment via EST fullcmc
output.list=o1
output.o1.class_id=certOutputImpl
policyset.cmcDeviceCertSet.1.constraint.class_id=raHeaderClientCertSubjectNameConstraintImpl
policyset.cmcDeviceCertSet.1.constraint.name=RA Header Client Cert Subject Name Constraint
policyset.cmcDeviceCertSet.1.default.class_id=userSubjectNameDefaultImpl
policyset.cmcDeviceCertSet.1.default.name=Subject Name Default
policyset.cmcDeviceCertSet.1.default.params.name=
policyset.cmcDeviceCertSet.2.constraint.class_id=validityConstraintImpl
policyset.cmcDeviceCertSet.2.constraint.name=Validity Constraint
policyset.cmcDeviceCertSet.2.constraint.params.notAfterCheck=false
policyset.cmcDeviceCertSet.2.constraint.params.notBeforeCheck=false
policyset.cmcDeviceCertSet.2.constraint.params.range=365
policyset.cmcDeviceCertSet.2.default.class_id=validityDefaultImpl
policyset.cmcDeviceCertSet.2.default.name=Validity Default
policyset.cmcDeviceCertSet.2.default.params.range=180
policyset.cmcDeviceCertSet.2.default.params.startTime=0
policyset.cmcDeviceCertSet.3.constraint.class_id=keyConstraintImpl
policyset.cmcDeviceCertSet.3.constraint.name=Key Constraint
policyset.cmcDeviceCertSet.3.constraint.params.keyType=MLDSA
policyset.cmcDeviceCertSet.3.constraint.params.keyParameters=44,65,87
policyset.cmcDeviceCertSet.3.default.class_id=userKeyDefaultImpl
policyset.cmcDeviceCertSet.3.default.name=Key Default
policyset.cmcDeviceCertSet.4.constraint.class_id=noConstraintImpl
policyset.cmcDeviceCertSet.4.constraint.name=No Constraint
policyset.cmcDeviceCertSet.4.default.class_id=authorityKeyIdentifierExtDefaultImpl
policyset.cmcDeviceCertSet.4.default.name=Authority Key Identifier Default
policyset.cmcDeviceCertSet.5.constraint.class_id=noConstraintImpl
policyset.cmcDeviceCertSet.5.constraint.name=No Constraint
policyset.cmcDeviceCertSet.5.default.class_id=authInfoAccessExtDefaultImpl
policyset.cmcDeviceCertSet.5.default.name=AIA Extension Default
policyset.cmcDeviceCertSet.5.default.params.authInfoAccessADEnable_0=true
policyset.cmcDeviceCertSet.5.default.params.authInfoAccessADLocationType_0=URIName
policyset.cmcDeviceCertSet.5.default.params.authInfoAccessADLocation_0=
policyset.cmcDeviceCertSet.5.default.params.authInfoAccessADMethod_0=1.3.6.1.5.5.7.48.1
policyset.cmcDeviceCertSet.5.default.params.authInfoAccessCritical=false
policyset.cmcDeviceCertSet.5.default.params.authInfoAccessNumADs=1
policyset.cmcDeviceCertSet.6.constraint.class_id=keyUsageExtConstraintImpl
policyset.cmcDeviceCertSet.6.constraint.name=Key Usage Extension Constraint
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageCritical=true
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageCrlSign=false
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageDataEncipherment=false
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageDecipherOnly=false
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageDigitalSignature=true
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageEncipherOnly=false
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageKeyAgreement=false
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageKeyCertSign=false
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageKeyEncipherment=true
policyset.cmcDeviceCertSet.6.constraint.params.keyUsageNonRepudiation=false
policyset.cmcDeviceCertSet.6.default.class_id=keyUsageExtDefaultImpl
policyset.cmcDeviceCertSet.6.default.name=Key Usage Default
policyset.cmcDeviceCertSet.6.default.params.keyUsageCritical=true
policyset.cmcDeviceCertSet.6.default.params.keyUsageCrlSign=false
policyset.cmcDeviceCertSet.6.default.params.keyUsageDataEncipherment=false
policyset.cmcDeviceCertSet.6.default.params.keyUsageDecipherOnly=false
policyset.cmcDeviceCertSet.6.default.params.keyUsageDigitalSignature=true
policyset.cmcDeviceCertSet.6.default.params.keyUsageEncipherOnly=false
policyset.cmcDeviceCertSet.6.default.params.keyUsageKeyAgreement=false
policyset.cmcDeviceCertSet.6.default.params.keyUsageKeyCertSign=false
policyset.cmcDeviceCertSet.6.default.params.keyUsageKeyEncipherment=true
policyset.cmcDeviceCertSet.6.default.params.keyUsageNonRepudiation=false
policyset.cmcDeviceCertSet.7.constraint.class_id=noConstraintImpl
policyset.cmcDeviceCertSet.7.constraint.name=No Constraint
policyset.cmcDeviceCertSet.7.default.class_id=extendedKeyUsageExtDefaultImpl
policyset.cmcDeviceCertSet.7.default.name=Extended Key Usage Extension Default
policyset.cmcDeviceCertSet.7.default.params.exKeyUsageCritical=false
policyset.cmcDeviceCertSet.7.default.params.exKeyUsageOIDs=1.3.6.1.5.5.7.3.2
policyset.cmcDeviceCertSet.8.constraint.class_id=signingAlgConstraintImpl
policyset.cmcDeviceCertSet.8.constraint.name=Signing Algorithm Constraint
policyset.cmcDeviceCertSet.8.constraint.params.signingAlgsAllowed=ML-DSA-44,ML-DSA-65,ML-DSA-87
policyset.cmcDeviceCertSet.8.default.class_id=signingAlgDefaultImpl
policyset.cmcDeviceCertSet.8.default.name=Signing Alg
policyset.cmcDeviceCertSet.8.default.params.signingAlg=-
policyset.cmcDeviceCertSet.list=1,2,3,4,5,6,7,8
policyset.list=cmcDeviceCertSet
visible=false
----

. Edit `/var/lib/pki/pki-ca/ca/conf/CS.cfg` and make the following changes:

.. Update `profile.list` to include `estFullcmcMLDSADeviceCert`

.. Add the line
+
[source,bash]
----
profile.estFullcmcMLDSADeviceCert.class_id=caEnrollImpl
----
. Restart CA:
+
[source,bash]
...
[source,bash]
----
 pki -n caadmin --skip-revocation-check ca-profile-show estFullcmcMLDSADeviceCert
----
+
You should see:
+
...
----
-----------------------------------
Profile "estFullcmcMLDSADeviceCert"
-----------------------------------
  Profile ID: estFullcmcMLDSADeviceCert
  Name: CMC-Authenticated ML-DSA Device Certificate Enrollment via EST fullcmc
  ... output omitted ... 
----

. Update EST backend configuration to use the ML-DSA profile:
+
[source,bash]
----
sed -i 's/fullcmc.profile=estFullcmcDeviceCert/fullcmc.profile=estFullcmcMLDSADeviceCert/' /var/lib/pki/pki-est/est/conf/backend.conf
----
...
[source,bash]
----
grep fullcmc.profile /var/lib/pki/pki-est/est/conf/backend.conf
----
+
You should see:
+
----
fullcmc.profile=estFullcmcMLDSADeviceCert
----
...
----
# Create user in CA
pki -d ~/.dogtag/nssdb -n caadmin ca-user-add est-ca-agent --full-name "EST CA Agent User"
...
[NOTE]
====
Testing for `Non-PQC deployments` is specified in steps 21-23

Testing for `PQC deployments` is specified in steps 24-26
====
...
==== Testing for Non-PQC Deployments 
...
=== Step 24: Test ML-DSA Non-Agent Enrollment (Matching Subject)
==== Testing for PQC Deployments
...
# Create CSR with SAME subject as est-nonrole-user cert
pki -d nssdb-nonrole -c Secret.123 nss-cert-request \
    --subject "UID=est-nonrole-user,CN=EST NonRole User" \
    --key-type mldsa --key-strength 65 \
    --ext /usr/share/pki/tools/examples/certs/device.conf \
    --csr device1-mldsa.csr

# Convert to base64-encoded DER format (without PEM headers)
openssl req -in device1-mldsa.csr -outform der | openssl base64 -out device1-mldsa.p10
----

Create `est-nonrole-user-mldsa-cmc-req.cfg`:
...
# Path to the PKCS10 request (base64 encoded)
input=device1-mldsa.p10

# Path for the CMC request output
output=device1-mldsa-cmc.req
----
...
[source,bash]
----
CMCRequest est-nonrole-user-mldsa-cmc-req.cfg
----
...
curl -k \
    ...
    --key est-nonrole-user.key \
    -H "Content-Type: application/pkcs7-mime; smime-type=CMC-request" \
    --data-binary @device1-mldsa-cmc.req \
    https://pki.example.com:15443/.well-known/est/fullcmc \
    -o device1-mldsa-cmc-response.b64
----
...
----
# Decode base64 response to DER format
AtoB device1-mldsa-cmc-response.b64 device1-mldsa-cmc-response.der

# Extract certificate using CMCResponse tool
CMCResponse -d nssdb-nonrole -i device1-mldsa-cmc-response.der

# Or manually extract using openssl
openssl pkcs7 -inform DER -in device1-mldsa-cmc-response.der -print_certs -out device1-mldsa-cert.pem
openssl x509 -in device1-mldsa-cert.pem -noout -text
----

This should succeed because the CSR subject (`UID=est-nonrole-user,CN=EST NonRole User`) matches the client certificate subject. The issued certificate should use ML-DSA-65.

=== Step 25: Test ML-DSA Non-Agent Enrollment (Mismatched Subject - Expected Failure)
...
pki -d nssdb-nonrole -c Secret.123 nss-cert-request \
    ...
    --key-type mldsa --key-strength 65 \
    --ext /usr/share/pki/tools/examples/certs/device.conf \
    --csr device2-mldsa.csr

# Convert to base64-encoded DER format (without PEM headers)
openssl req -in device2-mldsa.csr -outform der | openssl base64 -out device2-mldsa.p10
----

Create `est-nonrole-user-mldsa-cmc-req-mismatch.cfg`:
...
format=pkcs10
numRequests=1
input=device2-mldsa.p10
output=device2-mldsa-cmc.req
----
...
[source,bash]
----
CMCRequest est-nonrole-user-mldsa-cmc-req-mismatch.cfg
----
...
curl -k \
    ...
    --key est-nonrole-user.key \
    -H "Content-Type: application/pkcs7-mime; smime-type=CMC-request" \
    --data-binary @device2-mldsa-cmc.req \
    https://pki.example.com:15443/.well-known/est/fullcmc \
    -o device2-mldsa-cmc-response.b64
----
...
----
# Decode base64 response to DER format
AtoB device2-mldsa-cmc-response.b64 device2-mldsa-cmc-response.der

# Extract certificate using CMCResponse tool
CMCResponse -d nssdb-nonrole -i device2-mldsa-cmc-response.der
----

This should fail with a subject name mismatch error because the CSR subject (`CN=Different Device`) does not match the client certificate subject (`UID=est-nonrole-user,CN=EST NonRole User`).
...
=== Step 26: Test ML-DSA Agent Enrollment (Any Subject - Should Succeed)
...
# Create CSR with ANY subject (different from agent cert)
pki -d nssdb-agent -c Secret.123 nss-cert-request \
    --subject "CN=Any Device Name" \
    --key-type mldsa --key-strength 65 \
    --ext /usr/share/pki/tools/examples/certs/device.conf \
    --csr device3-mldsa.csr

# Convert to base64-encoded DER format (without PEM headers)
openssl req -in device3-mldsa.csr -outform der | openssl base64 -out device3-mldsa.p10
----

Create `est-ca-agent-mldsa-cmc-req.cfg`:
...
format=pkcs10
numRequests=1
input=device3-mldsa.p10
output=device3-mldsa-cmc.req
----
...
[source,bash]
----
CMCRequest est-ca-agent-mldsa-cmc-req.cfg
----
...
curl -k \
    ...
    --key est-ca-agent.key \
    -H "Content-Type: application/pkcs7-mime; smime-type=CMC-request" \
    --data-binary @device3-mldsa-cmc.req \
    https://pki.example.com:15443/.well-known/est/fullcmc \
    -o device3-mldsa-cmc-response.b64
----
...
----
# Decode base64 response to DER format
AtoB device3-mldsa-cmc-response.b64 device3-mldsa-cmc-response.der

# Extract certificate using CMCResponse tool
CMCResponse -d nssdb-agent -i device3-mldsa-cmc-response.der

# Or manually extract using openssl
openssl pkcs7 -inform DER -in device3-mldsa-cmc-response.der -print_certs -out device3-mldsa-cert.pem
openssl x509 -in device3-mldsa-cert.pem -noout -text
----

This should succeed even though the CSR subject (`CN=Any Device Name`) does not match the client certificate subject (`CN=EST CA Agent User`), because the client is a CA agent and can request certificates with any subject name.
...
----
# Get serial number
DEVICE_SERIAL=$(openssl x509 -in device1-mldsa-cert.pem -noout -serial | cut -d= -f2 | python3 -c "print(int(input(), 16))")
