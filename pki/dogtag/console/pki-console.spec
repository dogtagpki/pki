...
##
BuildRequires:  ant >= 1.6.2, %{base_prefix}-util >= 1.0.0, %{base_flavor}-%{base_name}-ui >= 1.0.0, idm-console-framework >= 1.0.3, jpackage-utils >= 1.6.0, jss >= 4.2.4, ldapjdk >= 4.17, %{pki_jdk}
